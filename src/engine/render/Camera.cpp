...
{
    spdlog::trace("Camera constructed, position: {},{}", position_.x, position_.y);
}
...
glm::vec2 Camera::worldToScreenWitchParallax(const glm::vec2& world_pos, const glm::vec2& scroll_factor) const
{
